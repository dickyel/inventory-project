                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                        id="nama_line" value="{{$item->nama_line}}" name="nama_liner" class="form-control @error('nama_line') is-invalid @enderror"/>
                                        @error('nama_line')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                        id="set_up_time_plan" step="0.01" min="0" value="{{$item->set_up_time_plan}}"  name="set_up_time_plan" class="form-control @error('set_up_time_plan') is-invalid @enderror"/>
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                        id="running_time_plan" step="0.01" min="0" value="{{$item->running_time_plan}}"   name="running_time_plan" class="form-control @error('running_time_plan') is-invalid @enderror"/>
